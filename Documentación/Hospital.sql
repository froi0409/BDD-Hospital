...
CREATE TABLE IF NOT EXISTS INFORME(
  ...
  fecha DATE NOT NULL,
  hora TIME NOT NULL,
  codigo_cita_medica VARCHAR(50),
  codigo_medico VARCHAR(20) NOT NULL,
  codigo_paciente VARCHAR(20) NOT NULL,
  CONSTRAINT PK_INFORME PRIMARY KEY(codigo),
  CONSTRAINT FK_INFORME_CITA_MEDICA FOREIGN KEY(codigo_cita_medica) REFERENCES CITA_MEDICA(codigo),
...
CREATE TABLE IF NOT EXISTS RESULTADO(
  ...
  codigo_paciente VARCHAR(20) NOT NULL,
  codigo_examen VARCHAR(20) NOT NULL,
  codigo_cita_laboratorio VARCHAR(20),
