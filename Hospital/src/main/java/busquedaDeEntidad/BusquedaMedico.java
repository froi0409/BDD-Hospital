...
public class BusquedaMedico {
    ...
    /**
     * Obtiene los datos de todos los medicos
     * @param connection Conexión de la base de datos
     * @return ArrayList tipo String[] que contiene los datos de todos los medicos
     */
    public ArrayList<String[]> allAttributes (Connection connection) {
        ArrayList<String[]> lista = new ArrayList<String[]>();
        String query = "SELECT codigo,nombre,colegiado,DPI,horario_inicio,horario_fin,telefono,correo FROM MEDICO";
