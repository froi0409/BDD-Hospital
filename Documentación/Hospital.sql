...
CREATE TABLE IF NOT EXISTS PACIENTE(
  ...
  correo VARCHAR(75) NOT NULL,
  password VARCHAR(75) NOT NULL,
  CONSTRAINT PK_PACIENTE PRIMARY KEY(DPI)
);
...
CREATE TABLE IF NOT EXISTS LABORATORISTA(
  ...
  dias_trabajo_codigo VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS CITA_MEDICA(
  ...
  CONSTRAINT FK_CITA_MEDICA_PACIENTE FOREIGN KEY(DPI_paciente) REFERENCES PACIENTE(DPI),
...
CREATE TABLE IF NOT EXISTS INFORME(
  ...
  CONSTRAINT FK_INFORME_PACIENTE FOREIGN KEY(DPI_paciente) REFERENCES PACIENTE(DPI)
);
...
CREATE TABLE IF NOT EXISTS RESULTADO(
  ...
  CONSTRAINT FK_RESULTADO_PACIENTE FOREIGN KEY(DPI_paciente) REFERENCES PACIENTE(DPI),
...
CREATE TABLE IF NOT EXISTS CITA_LABORATORIO(
  ...
  CONSTRAINT FK_CITA_LABORATORIO_MEDICO FOREIGN KEY(codigo_medico) REFERENCES MEDICO(codigo),
  CONSTRAINT FK_CITA_LABORATORIO_PACIENTE FOREIGN KEY(DPI_paciente) REFERENCES PACIENTE(DPI),
