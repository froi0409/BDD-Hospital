<%-- 
    Document   : administrador-reporte-medicos-informes
    Created on : 8/10/2020, 11:53:02
    Author     : froi-pc
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container" align="center" style="margin-top: 100px">
            <h1>Médicos con Más Informes</h1>
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    for(String[] element: administrador.medicosConMasInformes(Conexion.getConnection())){
                        out.println("<tr>");
